...
enter_first_name = driver.find_element_by_xpath('//*[@id="input-315"]')
enter_first_name.click()
time.sleep(1)
enter_first_name.send_keys('chetan')
time.sleep(2)

apply = driver.find_element_by_xpath('/html/body/div/div[2]/div/div[2]/button[1]')
apply.click()
time.sleep(2)

click_view_class = driver.find_element_by_xpath('/html/body/div/div[1]/div/main/div/div/div/div[3]/div/div[1]/table/tbody/tr/td[8]/button[4]')
